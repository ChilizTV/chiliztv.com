...
export function StreamCard({ stream }: { stream: StreamerCard }) {
  ...
  return (
    <article
      className="group relative overflow-hidden rounded-xl border bg-[#111] transition-all duration-200 hover:-translate-y-px"
    ...
    >
      ...
      <div className="flex items-center gap-3 px-3.5 py-3">
        ...
        <button
          ...
          className="font-mono-ctv flex-shrink-0 rounded-md border px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.14em] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E8001D]"
          style={{
            background: watching ? "#E8001D" : "transparent",
            borderColor: watching ? "#E8001D" : "#2A2A2A",
            color: watching ? "#fff" : "rgba(255,255,255,0.65)",
          }}
        >

...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: (
      <p className="m-0">
        Set <strong className="font-medium text-white">Service</strong> to <strong className="font-medium text-white">Custom…</strong> — don&apos;t use Twitch / YouTube presets. PredCast speaks RTMP directly, so the custom path is the right one.
      </p>
    ),
  },
  {
